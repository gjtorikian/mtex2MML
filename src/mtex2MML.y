...
leftroot: LEFTROOT closedTerm closedTerm {
  char * spacing = root_pos_to_em($2);

  char *s1 = mtex2MML_copy3("<mpadded width=\"", spacing, "\"><mrow>");
  $$ = mtex2MML_copy3(s1, $3, "</mrow></mpadded>");
